...
<main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
      <div class="container"><a class="navbar-brand" href="#"><img src="{{asset('/img/icons/logo.png')}}"  alt=""
          ...
          <ul class="navbar-nav mx-auto border-bottom border-lg-bottom-0 pt-2 pt-lg-0">
            ...
            <li class="nav-item">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <a class="dropdown-item" href="/desain/logo">Desian Logo</a>
                  <a class="dropdown-item" href="/desain/website">Desain Website</a>
                </div>
            </li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-4 mb-3"><a href="#"><img class="d-inline-block align-middle"
                 src="{{asset('/img/icons/logo.png')}}"  alt="" width="30" /><span
